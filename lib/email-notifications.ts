...
// Vault Logo SVG as Data URI (Blue #3b82f6)
const LOGO_DATA_URI = 'data:image/svg+xml;base64,'
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #3b82f6; padding: 20px; text-align: center;">
          <tr>
            <td>
              ...
              <h1 style="color: white; font-size: 24px; margin: 10px 0 0 0;">Vault Capital</h1>
            </td>
          </tr>
        </table>
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9fafb;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 20px; text-align: center;">
          <tr>
            <td>
              <img src="${LOGO_DATA_URI}" alt="Vault Capital" width="40" height="40" style="margin: 0 auto; display: block; margin-bottom: 10px;"/>
              <h1 style="color: white; font-size: 24px; margin: 10px 0 0 0;">Deposit Confirmed</h1>
            </td>
          </tr>
        </table>
        ...
        <div style="padding: 40px 20px; background-color: white;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 30px 0;">
            ...
            <tr>
              ...
              <td style="padding: 12px 0;"><span style="color: #10b981; font-weight: bold;">✓ Approved</span></td>
            </tr>
          </table>
          <div style="text-align: center;">
            <a href="${data.dashboardLink}" style="background-color: #3b82f6; color: white; padding: 12px 30px; border-radius: 6px; text-decoration: none; font-weight: 500;">View Dashboard</a>
          </div>
        </div>
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9fafb;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); padding: 20px; text-align: center;">
          <tr>
            <td>
              <img src="${LOGO_DATA_URI}" alt="Vault Capital" width="40" height="40" style="margin: 0 auto; display: block; margin-bottom: 10px;"/>
              <h1 style="color: white; font-size: 24px; margin: 10px 0 0 0;">Withdrawal Submitted</h1>
            </td>
          </tr>
        </table>
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9fafb;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 20px; text-align: center;">
          <tr>
            <td>
              <img src="${LOGO_DATA_URI}" alt="Vault Capital" width="40" height="40" style="margin: 0 auto; display: block; margin-bottom: 10px;"/>
              <h1 style="color: white; font-size: 24px; margin: 10px 0 0 0;">Return Credited</h1>
            </td>
          </tr>
        </table>
  ...
  welcome: (data: Record<string, string | number | boolean>) => ({
    ...
    html: `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9fafb;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); padding: 40px 20px; text-align: center;">
          <tr>
            <td>
              <img src="${LOGO_DATA_URI}" alt="Vault Capital" width="60" height="60" style="margin: 0 auto; display: block; margin-bottom: 20px;"/>
              <h1 style="color: white; font-size: 32px; margin: 0; font-weight: 700;">Welcome to Vault Capital</h1>
              <p style="color: rgba(255,255,255,0.9); font-size: 16px; margin: 10px 0 0 0;">Your journey to financial freedom starts here</p>
            </td>
          </tr>
        </table>
        ...
        <div style="padding: 40px 20px; background-color: white;">
          ...
          <div style="text-align: center; margin: 35px 0;">
            <a href="${data.dashboardLink}" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; padding: 14px 40px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block; transition: all 0.3s ease;">
              Go to Dashboard →
            </a>
          </div>
          ...
          <p style="color: #6b7280; font-size: 13px; margin: 30px 0 0 0;">
            If you have any questions or need assistance, please don't hesitate to <a href="mailto:support@vaultcapital.bond" style="color: #3b82f6; text-decoration: none;">contact our support team</a>.
          </p>
        </div>
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9fafb;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); padding: 20px; text-align: center;">
          <tr>
            <td>
              <img src="${LOGO_DATA_URI}" alt="Vault Capital" width="40" height="40" style="margin: 0 auto; display: block; margin-bottom: 10px;"/>
              <h1 style="color: white; font-size: 24px; margin: 10px 0 0 0;">Password Recovery</h1>
            </td>
          </tr>
        </table>
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9fafb;">
        ...
        <div style="padding: 40px 20px; background-color: white;">
          ...
          <div style="background-color: #eff6ff; border-left: 4px solid #3b82f6; padding: 15px; border-radius: 4px; margin: 30px 0;">
            <p style="color: #1e40af; font-size: 13px; margin: 0;"><strong>🔒 Security Tip:</strong> Never share this code with anyone. Vault staff will never ask for it.</p>
          </div>
