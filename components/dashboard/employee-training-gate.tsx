...
import { Download, Lock, MonitorCheck, ShieldCheck, Sparkles, UserRound } from "lucide-react"
      ...
      <div className="flex flex-col gap-6">
        <div className="rounded-2xl border border-border/70 bg-card/90 p-6 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-sm font-medium text-muted-foreground">Employee access portal</p>
          ...
          <form onSubmit={handleAccessSubmit} className="mt-6 grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-xl border border-border/70 bg-background/70 p-5">
              ...
              <div className="mt-4 space-y-3">
                <label className="block text-sm font-medium text-foreground">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-lg border border-border bg-background px-3 py-2 text-sm outline-none ring-0"
              ...
              {accessError ? <p className="mt-3 text-sm text-amber-600">{accessError}</p> : null}

              <button
                type="submit"
                disabled={isSubmitting}
                className="mt-4 inline-flex w-full items-center justify-center rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60"
              >
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.3fr_0.7fr]">
          ...
          <div className="rounded-xl border border-border/70 bg-background/70 p-5">
            ...
            <button
              ...
              className="mt-4 inline-flex w-full items-center justify-center rounded-lg border border-primary/20 bg-primary/10 px-4 py-2 text-sm font-medium text-primary transition hover:bg-primary/15 disabled:cursor-not-allowed disabled:opacity-60"
            >
      ...
      {hasCompletedTraining ? (
        <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground">Employee dashboard unlocked</h3>
        ...
        <div className="rounded-2xl border border-amber-500/20 bg-amber-500/10 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground">Employee dashboard locked</h3>
              <p className="mt-1 text-sm text-muted-foreground">
