...
const plans = [
  ...
  {
    name: "Premium",
    description: "For experienced investors maximizing wealth growth",
    monthlyReturn: "18-22%",
    minInvestment: "$5,000",
    duration: "90 days",
    features: [
...
const comparisonFeatures = [
  { feature: "Minimum Investment", starter: "$100", professional: "$1,000", premium: "$5,000" },
  { feature: "Lock-in Period", starter: "30 days", professional: "60 days", premium: "90 days" },
  { feature: "Expected Monthly Return", starter: "8-10%", professional: "12-15%", premium: "18-22%" },
  { feature: "Portfolio Rebalancing", starter: "Quarterly", professional: "Monthly", premium: "Weekly" },
  ...
  { feature: "Risk Level", starter: "Conservative", professional: "Moderate", premium: "Balanced" },
